...
# Stage-08 / Example-04
# Purpose: poll MARS MMIO keyboard and echo chars to display
# Exit condition: press Enter (ASCII 10)

.data
msg: .asciiz "[08_04] Type characters. Press Enter to exit.\n"
bye: .asciiz "\n[08_04] Echo ended.\n"
